            ...
            <article id="view" className="container-lg my-3">
                ...
                <main>
                    ...
                    <div className="row pt-2 px-3">
                        ...
                        <div data-aos="fade-down" className="container col-xs-12 col-md-6 col-lg-4">
                        ...
                        <div data-aos="fade-left" className="container col-xs-12 col-md-6 col-lg-4">
                            <a href="https://pizza-app-p3.herokuapp.com/"><img className="d-flex img-fluid" src={Pizza} alt="PizzaPage"></img></a>
                            <div className="overlay">
                                <div className="text">Some text</div>
                            </div>
                        </div>
                        <div data-aos="fade-up" className="container col-xs-12 col-md-6 col-lg-4">
