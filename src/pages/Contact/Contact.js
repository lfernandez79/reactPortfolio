                ...
                <div className="row">
                    <div className="col-sm-12 col-md-12 card w-75 border-0">
                        <div className="card-body">
                            ...
                            <a className="d-flex flex-row-reverse" href="https://www.linkedin.com/in/joseleonardofernandez/"><i className="fab fa-linkedin-in fa-1x pt-2"></i></a>
                            <a className="d-flex flex-row-reverse mt-1" href="https://github.com/lfernandez79"><i className="fab fa-github fa-1x pt-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
